...
//   console.log("ComplaintsTable rendered with complaints:", selectedComplaint);
// // console.log('Engineer:',handleAssignEngineer)
...
//               {/* This is the filter which gets applied to the json data backend is sending! */}
          ...
          <table className="admin-dashboard-table">
            ...
            <tbody>
              {filteredComplaints.map((complaint) => (
                <tr key={complaint.id}>
                  <td>{complaint.id}</td>
                  <td className="admin-dashboard-title-cell">{complaint.title}</td>
                  <td>{complaint.submitted_by || "Unknown"}</td>
                  <td>
                    <span className="admin-dashboard-category-badge">
                      {complaint.category}
